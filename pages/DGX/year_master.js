...
const validationSchema = Yup.object({
    ...
    date: Yup.string().required("Group is required"),
    end: Yup.string().required("TYPE is required"),
});
                        ...
                        {({ errors, touched, resetForm }) => (
                            <Form className="row mt-2 fw-bold">
                                <div className="col-md-6 col-12">
                                    <div className="mt-2">FYear ID</div>
                                    <Field className="form-control mt-2" name="id" />
                                    {errors.code && touched.code ? (
                                        <div className="text-danger mt-1">{errors.code}</div>
                                    ) : null}
                                </div>
                                <div className="col-md-6 col-12">
                                    <div className="mt-2">FYear Name</div>
                                ...
                                <div className="col-md-6 col-12">
                                    ...
                                    <Field className="form-control mt-2" name="end" />
